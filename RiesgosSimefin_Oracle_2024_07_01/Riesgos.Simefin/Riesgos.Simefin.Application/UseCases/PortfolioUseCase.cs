...
namespace Riesgos.Simefin.Application.UseCases
{
    ...
    public class PortfolioUseCase : IPortfolioUseCase
    {
        ...
        private string serverFileUrlPath = string.Empty;
        private string nameDestinationFolderServer = string.Empty;
        private string nameSourceFolderServer = string.Empty;
        ...
        public PortfolioUseCase(IPortfolioRepository portfolioRepository, IConfiguration configuration)
        {
            ...
            serverFileUrlPath = _configuration.GetSection("FileUpload").GetSection("ServerFileUrlPath").Value!;
            nameDestinationFolderServer = _configuration.GetSection("FileUpload").GetSection("NameDestinationFolderServer").Value!;
            nameSourceFolderServer = _configuration.GetSection("FileUpload").GetSection("NameSourceFolderServer").Value!;
        ...
        private ResponseDTO ValidateFileExist(ref IFormFile file)
        {
            ...
            if (file == null || file.Length == 0)
            {
                ...
                string pathServerFolderComplete = @$"{this.serverFileUrlPath}{this.nameSourceFolderServer}{this.fileName}";
        ...
        private async Task<ResponseDTO> MoveFileToServerFolder()
        {
            ...
            string sourcePath = @$"{this.serverFileUrlPath}{this.nameSourceFolderServer}{this.fileName}";
            string destinationPath = @$"{this.serverFileUrlPath}{this.nameDestinationFolderServer}{name}-[{date}]{extension}";
