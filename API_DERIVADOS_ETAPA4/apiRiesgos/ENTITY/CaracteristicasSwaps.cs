...
namespace ENTITY
{
    public class CaracteristicasSwaps
    {
        ...
        public string Cve_Inst { get; set; }
        ...
        public string Base_Cal_Tasa { get; set; }
        ...
        public string Formula_Flujo { get; set; }
        ...
        public string Reinvierte_int_Act { get; set; }
        public string Reinvierte_int_Pas { get; set; }
