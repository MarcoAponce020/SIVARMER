    ...
    public class RiesgosController : Controller
    {
        ...
        public async Task<Respuesta> GetRiesgos(int tipoReporte, int fechaConsulta, string token)
        {
            ...
            else if (tipoReporte == 13)
            {
                ...
                {
                    respuesta = new DALRiesgos().guardarPosicionForwards(respuestaAPI.listaPosicionForwards, conn);
                }
                else
                {
                    respuesta.mensaje = "No hay registros en SIMEFIN para insertar en la base de datos.";
            ...
            else if (tipoReporte == 14)
            {
                ...
                {
                    respuesta = new DALRiesgos().guardarFlujosSwaps(respuestaAPI.listaFlujosSwaps, connDerivados);
                }
                else
                {
                    respuesta.mensaje = "No hay registros en SIMEFIN para insertar en la base de datos.";
            ...
            else if (tipoReporte == 16)
            {
                ...
                {
                    respuesta = new DALRiesgos().guardarCaracteristicasSwaps(respuestaAPI.listaCaracteristicasSwaps, connDerivados);
                }
                else
                {
                    respuesta.mensaje = "No hay registros en SIMEFIN para insertar en la base de datos.";
            ...
            else if (tipoReporte == 18)
            {
                ...
                if (respuestaAPI.listaPosicionPrimariaSwaps != null)
                {
                    respuesta = new DALRiesgos().guardarPosicionPrimariaSwaps(respuestaAPI.listaPosicionPrimariaSwaps, conn);
                }
                else
                {
                    respuesta.mensaje = "No hay registros en SIMEFIN para insertar en la base de datos.";
            ...
            else if (tipoReporte == 19)
            {
                ...
                {
                    respuesta = new DALRiesgos().guardarReporteOperacionCVDivisas(respuestaAPI.listaOperacionCVDivisas, conn);
                }
                else
                {
                    respuesta.mensaje = "No hay registros en SIMEFIN para insertar en la base de datos.";
