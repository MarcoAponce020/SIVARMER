...
namespace Riesgos.Simefin.Application.UseCases
{
    ...
    public class PortfolioUseCase : IPortfolioUseCase
    {
        ...
        private string uploadServerFileUrlPath = string.Empty;
        private string uploadServerFolderSource = string.Empty;
        private string downloadServerFileUrlPath = string.Empty;
        private string downloadServerFolderDestination = string.Empty;
