...
namespace DAO
{
    public class DAORiesgos
    {
        ...
        public Respuesta guardarFlujosSwaps(List<FlujosSwaps> reporte, List<CatalogoDivisas> catalogoDivisas, OracleConnection conexion)
        {
            ...
            borro = this.R14_EliminarFlujoswaps(Convert.ToInt32(reporte[0].Fecha_Pos), conexion);
            ...
            try
            {
                ...
                foreach (FlujosSwaps item in reporte)
                {
                    ...
                    string query0 = "INSERT INTO XYZWIN.SW_RIESGOS1 (FECHA_POS" +
                                        ",CVESWAP" +
                                        ",POSICION" +
                                        ",SECUENCIA" +
                                        ",TIP_NEGOC" +
                    ...
                    string query1 = "INSERT INTO XYZWIN.SW_RIESGOS1_TEMP (FECHA_POS" +
                                        ",CVESWAP" +
                                        ",POSICION" +
                                        ",SECUENCIA" +
                                        ",TIP_NEGOC" +
                    ...
                    string query2 = "INSERT INTO XYZWIN.SW_RIESGOS1_COPIA (FECHA_POS" +
                                        ",CVESWAP" +
                                        ",POSICION" +
                                        ",SECUENCIA" +
                                        ",TIP_NEGOC" +
                                        ...
                                        ",NEGO_ESTRUC" +
                                        ",PAGA_INT) " +
                                        "VALUES (to_date(:FECHA_POS,'yyyymmdd'),:CVESWAP,:POSICION,:SECUENCIA,:TIP_NEGOC,to_date(:FEC_INI,'yyyymmdd'),to_date(:FEC_TER,'yyyymmdd'),to_date(:FEC_INI_R,'yyyymmdd'),to_date(:FEC_TER_R,'yyyymmdd'),:VALOR_NOC,:AMORTIZACION,:TASA,:SPREAD,:CUPON,:CONVENCION,:NUMMON,:TIP_SWAP,:ID_SIDE,:INTERI,:INTERF,to_date(:FEC_LIQ,'yyyymmdd'),:NEGO_ESTRUC,:PAGA_INT)";
                ...
                respuesta.exito = true;
                respuesta.mensaje = $"{ aff1 }, registros fueron insertados.";
            }
            catch (Exception ex)
            {
                respuesta.mensaje = "Hubo un error al insertar los registros. " + ex.Message;
        ...
        /// <param name="conexion"></param>
        /// <returns></returns>
        public bool R14_EliminarFlujoswaps(int fechaConsulta, OracleConnection conexion)
        {
            bool exito = false;
            ...
            try
            {
                ...
                cmd.CommandText = String.Format("DELETE FROM XYZWIN.SW_RIESGOS1_TEMP");
                cmd.ExecuteNonQuery();

                cmd.CommandText = String.Format("DELETE FROM XYZWIN.SW_RIESGOS1_COPIA");
                cmd.ExecuteNonQuery();
        ...
        public async Task<Respuesta> FlujosPosicionesPrimariasProcess(int fechaConsulta, List<FlujosPosicionesPrimarias> apiDataList, OracleConnection conexion)
        {
            ...
            //TEMPORAL
            //mirrorDataList = mirrorDataList.Where(x => x.COperacion == "2417/8386 BIRF-4").ToList();
            //var mirrorDataList4 = apiDataList.Where(x => x.COperacion == "2416/8386 BIRF-4").ToList();
            //var mirrorDataList5 = apiDataList.Where(x => x.COperacion == "2417/8386 BIRF-5").ToList();
            //var mirrorDataList6 = apiDataList.Where(x => x.COperacion == "2418/8386 BIRF-6").ToList();
            //var mirrorDataList7 = apiDataList.Where(x => x.COperacion == "2419/8386 BIRF-7").ToList();
            //var mirrorDataList8 = apiDataList.Where(x => x.COperacion == "2420/8386 BIRF-8").ToList();
            //var mirrorDataList9 = apiDataList.Where(x => x.COperacion == "2421/8386 BIRF-9").ToList();
            //var mirrorDataList10 = apiDataList.Where(x => x.F_Desc == null || x.F_Desc == 0).ToList();

            try
            {
                //Obteniendo el conjunto de datos de la tabla productiva
                var productionDataList = await this.R15_GetProductionData(fechaConsulta.ToString(), conexion);
              //  var productionDataList = await this.R15_GetProductionData(DateTime.UtcNow.AddDays(-1).ToString("yyyyMMdd"), conexion);
                ...
                foreach (var groupCOperacion in mirrorDataGroups)
                {
                    ...
                    {
                        respuesta = this.R15_SaveFlujosPosicionesPrimarias(groupCOperacion.ToList(), fechaConsulta.ToString(), conexion);
                    ...
                    if (currentApiDataList_B.Count != currentProductionList_B.Count)
                    {
                        ...
                        respuesta =  this.R15_SaveFlujosPosicionesPrimarias(currentApiDataList_B, fechaConsulta.ToString(), conexion);
                    ...
                    else
                    {
                        ...
                        {
                            respuesta = this.R15_SaveFlujosPosicionesPrimarias(newDataList, fechaConsulta.ToString(), conexion);
                            response.ListaMensajes.Add(respuesta.mensaje);
                        }
                    }
                    ...
                    {
                        //Si hay diferencia, insertar todos los registros espejo en tabla productiva
                        respuesta = this.R15_SaveFlujosPosicionesPrimarias(currentApiDataList_C, fechaConsulta.ToString(), conexion);
                        response.ListaMensajes.Add(respuesta.mensaje);
                    }
                    else
                    {
        ...
        /// <param name="conexion"></param>
        /// <returns></returns>
        private async Task<List<FlujosPosicionesPrimarias>> R15_GetProductionData(string fechaConsulta, OracleConnection conexion)
        {
            List<FlujosPosicionesPrimarias> productionDataList = new List<FlujosPosicionesPrimarias>();

            try
            {
                string strSQL = "SELECT * FROM RIESVARM.VAR_TD_FLUJOS_SWAPS WHERE TIPOPOS = 1 AND CPOSICION = 50 AND (T_PATA = 'B' OR T_PATA = 'C')";
        ...
        /// <param name="conexion"></param>
        /// <returns></returns>
        private Respuesta R15_SaveFlujosPosicionesPrimarias(List<FlujosPosicionesPrimarias> dataList,string fechaConsulta, OracleConnection conexion)
        {
            Respuesta response = new Respuesta { exito = false };
            //string strDateSave = DateTime.UtcNow.AddDays(-1).ToString("yyyyMMdd");
            string strDateSave= fechaConsulta.ToString();
            ...
            try
            {
                ...
                foreach (FlujosPosicionesPrimarias item in dataList)
                {
                    ...
                    cmd.Parameters.Add("FECHA_LIQ", item.FechaLiq == 0 ? null : item.FechaLiq);
                    cmd.Parameters.Add("F_DESC", item.F_Desc == 0 ? null : item.F_Desc);
                    ...
                    cmd.BindByName = true;
                    cmd.CommandText = "INSERT INTO RIESVARM.VAR_TD_FLUJOS_SWAPS (" +
                    //cmd.CommandText = "INSERT INTO RIESVARM.VAR_TD_FLUJOS_SWAPS_BK (" +
                                            "AMORTIZACION" +
                                            ", COPERACION" +
                                            ", CPOSICION" +
                                            ", FECHAREG" +
                                        ...
                                        "VALUES (" +
                                            ...
                                            ", :COPERACION" +
                                            ", :CPOSICION" +
                                            ", to_date(:FECHAREG ,'yyyymmdd')" +
                                            (item.FechaLiq == 0 ? ", :FECHA_LIQ" : ", to_date(:FECHA_LIQ,'yyyymmdd')") +
                                            (item.F_Desc == 0 ? ", :F_DESC" : ", to_date(:F_DESC,'yyyymmdd')") +
                                            ", to_date(:F_FINAL,'yyyymmdd')" +
                                            ", to_date(:F_FIXING,'yyyymmdd')" +
                                            ", to_date(:F_INICIO,'yyyymmdd')" +
                                            ", :HORAREG" +
                                            ", :INT_S_SALDO" +
                                            ", :NOMPOS" +
                                            ", :PAGO_INT" +
        ...
        public bool R16_EliminarCaracteristicasSwaps(int fechaConsulta, OracleConnection conexion)
        {
            ...
            try
            {
                ...
                cmd.CommandText = String.Format("DELETE FROM XYZWIN.SW_RIESGOS2_TEMP ");
                cmd.ExecuteNonQuery();

                cmd.CommandText = String.Format("DELETE FROM XYZWIN.SW_RIESGOS2_COPIA  ");
                cmd.ExecuteNonQuery();
        ...
        /// <param name="conexion"></param>
        /// <returns></returns>
        public async Task<Respuesta> guardarPosicionPrimariaSwaps_OLD(int fechaConsulta, List<PosicionPrimariaSwaps> mirrorDataList, OracleConnection conexion)
        {
            ...
            respuesta = this.R18_EliminarPosicionesPrimariasSwaps(fechaConsulta, conexion);
            //respuesta = this.R18_EliminarPosicionesPrimariasSwaps(Convert.ToInt32(newFechareg), conexion);
            if (!respuesta.exito)
            {
                return respuesta;
            }
            ...
            //Obteniendo el conjunto de datos de la tabla productiva
            int position = 1;
            var productionDataList = await this.R18_GetProductionData(position, fechaConsulta.ToString(), conexion);
            // var productionDataList = await this.R18_GetProductionData(position, newFechareg, conexion);
            ...
            if (productionDataList.Any() && productionDataList.Count > 0)
            {
                ...
                newDataList = mirrorDataList.Where(sc => sc.Tipopos == position && !productionDataList.Any(dc =>
            ...
            respuesta = this.R18_SavePosicionPrimariaSwaps(newDataList, mirrorDataList, conexion, fechaConsulta.ToString());
        ...
        public async Task<Respuesta> guardarPosicionPrimariaSwaps(int fechaOperacion, List<PosicionPrimariaSwaps> apiDataList, OracleConnection conexion)
        {
            ...
            string? newFechareg = apiDataList[0].Fechareg == null ? DateTime.Now.AddDays(-1).ToString("yyyyMMdd") : apiDataList[0].Fechareg.ToString();
            ...
            //Obteniendo el conjunto de datos de la tabla productiva
            var productionDataList = await this.R18_GetProductionData(position, fechaOperacion.ToString(), conexion);
            // var productionDataList = await this.R18_GetProductionData(position, newFechareg, conexion);
            //var results = await Task.Run(() => this.GetProductionData(position, newFechareg!, conexion));
        ...
        {
            string result = $"INSERT INTO {tableName} (AC_INT_ACT, " +
                                "AC_INT_PAS, " +
                                "CAL_F_T_ACTIVA, " +
                                "CAL_F_T_PASIVA, " +
                                "CAL_LIQ_ACTIVA, " +
                                ...
                                "TIPOPOS, " +
                                "TIPO_POS_COB) " +
                    "VALUES (:AC_INT_ACT, :AC_INT_PAS, :CAL_F_T_ACTIVA, :CAL_F_T_PASIVA, :CAL_LIQ_ACTIVA, :CAL_LIQ_PASIVA, :COLATERAL, " +
                            ":CONV_INT_ACT, :CONV_INT_PAS, :COPERACION, :CPOSICION, :C_PRODUCTO, :D_ANTE_ACTIVA, :D_ANTE_PASIVA, :ESTRUCTURAL, " +
                            "to_date(:FECHAREG,'yyyymmdd'), to_date(:FINICIO,'yyyymmdd'), :F_VALUACION, to_date(:FVENCIMIENTO,'yyyymmdd'), :HORAREG, :ID_BANXICO, :ID_CONTRAP, :INTENCION, :INTER_F, :INTER_I, " +
                            ":LLAMA_MARGEN, :MONEDA_ACT, :MONEDA_PAS, :NOMPOS, :OP_ST_ACTIVA, :OP_ST_PASIVA, :PORC_COB, :PX_SWAP, :REF_POS_COB, " +
                            ":ST_ACTIVA, :ST_PASIVA, :TC_ACTIVA, :TC_PASIVA, :TIPOPOS, :TIPO_POS_COB)";
        ...
        /// <param name="conexion"></param>
        /// <returns></returns>
        private Respuesta R18_EliminarPosicionesPrimariasSwaps(int fechaConsulta, OracleConnection conexion)
        {
            Respuesta response = new Respuesta { exito = false };            
        ...
        /// <param name="conexion"></param>
        /// <returns></returns>
        private async Task<List<PosicionPrimariaSwaps>> R18_GetProductionData(int position, string fechaConsulta, OracleConnection conexion)
        {
            List<PosicionPrimariaSwaps> productionDataList = new List<PosicionPrimariaSwaps>(); 
            OracleCommand cmd = new OracleCommand();
            string cOperacion = string.Empty;
            string cPosicion = string.Empty;
            ...
            try
            {
                ...
                string strSQL = String.Format("SELECT * FROM RIESVARM.VAR_TD_POS_SWAPS WHERE TIPOPOS = :POSICION", position);
                ...
                // string strSQL = String.Format("SELECT * FROM RIESVARM.VAR_TD_POS_SWAPS_BK WHERE TIPOPOS = :POSICION AND FECHAREG = to_date(:FECHAREG,'yyyymmdd')", fechaConsulta);
                cmd.CommandText = strSQL;
                cmd.BindByName = true;
                ...
                if (reader.HasRows)
                {
                    while (reader.Read())
                    {
                        cOperacion = reader["CPosicion"].ToString()!;
                        cPosicion = reader["COperacion"].ToString()!;
            ...
            {
                string message = this.GetExceptionMessage(ex);
                throw;
            }
            finally
            {
                                                        ...
                                                        OracleConnection conexion, string registrationDate)
        {
            ...
            try
            {
                ...
                foreach (PosicionPrimariaSwaps item in productionDataList)
                {
                    ...
                    cmdOracle.CommandText = this.R18_GetStringSQLProduction("RIESVARM.VAR_TD_POS_SWAPS");
                ...
                foreach (PosicionPrimariaSwaps item in mirrorDataList)
                {
                    ...
                    cmdOracle.CommandText = this.R18_GetStringSQLMirror("RIESVARM.VAR_TD_POS_SWAPS_BK");
