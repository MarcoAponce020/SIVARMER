    ...
    public partial class Service1 : ServiceBase
    {
        ...
        public async void EnviarEvidencia(string comentarios, string fecOper)
        {
            ...
            try
            {
                ...
                string user = ConfigurationManager.AppSettings["CorreoUsuario"];//usuario del correo.
                string password = ConfigurationManager.AppSettings["CorreoPass"];//password del usuario
                ...
                else
                {
                    ...
                    log.Info("No se encontraron direcciones de correo para enviar.");
                }
            }
            catch (Exception ex)
            {
